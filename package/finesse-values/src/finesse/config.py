...
class SequenceLengthConfig(BaseModel):
    ...
    values: Optional[List[int]] = Field(default=None, description="Explicit L values. If set, overrides min/max range iteration.")
    class Config:
    ...
    def get_lengths(self) -> List[int]:
        """Return the list of L values to evaluate.
        If values is explicitly set, return those sorted.
        Otherwise, return the full sequential range [min, max].
        """
